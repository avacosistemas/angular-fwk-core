...
import { FwkAnimationCurves, FwkAnimationDurations } from './defaults';
...
const fadeIn = trigger('fadeIn',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${FwkAnimationDurations.entering} ${FwkAnimationCurves.deceleration}`,
                },
            },
        ),
    ],
...
const fadeOut = trigger('fadeOut',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${FwkAnimationDurations.exiting} ${FwkAnimationCurves.acceleration}`,
                },
            },
        ),
    ],
