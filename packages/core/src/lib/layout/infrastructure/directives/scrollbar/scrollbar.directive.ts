 ...
 */
@Directive({
    selector  : '[fwkScrollbar]',
    exportAs  : 'fwkScrollbar',
    standalone: true,
})
export class FwkScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_fwkScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() fwkScrollbar: boolean = true;
    @Input() fwkScrollbarOptions!: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'fwkScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.fwkScrollbar = coerceBooleanProperty(changes.fwkScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.fwkScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'fwkScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.fwkScrollbarOptions.currentValue);
