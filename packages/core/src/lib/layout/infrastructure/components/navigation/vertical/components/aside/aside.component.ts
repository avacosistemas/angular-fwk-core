...
@Component({
    selector: 'fwk-vertical-navigation-aside-item',
    templateUrl    : './aside.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone     : true,
    imports        : [NgClass, MatTooltipModule, NgIf, MatIconModule, NgFor, FwkVerticalNavigationBasicItemComponent, FwkVerticalNavigationCollapsableItemComponent, FwkVerticalNavigationDividerItemComponent, FwkVerticalNavigationGroupItemComponent, FwkVerticalNavigationSpacerItemComponent],
})
export class FwkVerticalNavigationAsideItemComponent implements OnChanges, OnInit, OnDestroy
{
