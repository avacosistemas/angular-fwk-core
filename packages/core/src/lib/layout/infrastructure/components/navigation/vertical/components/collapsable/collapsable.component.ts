...
import { FwkVerticalNavigationGroupItemComponent } from '../group/group.component';
...
@Component({
    selector: 'fwk-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : fwkAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone     : true,
    imports        : [NgClass, MatTooltipModule, NgIf, MatIconModule, NgFor, FwkVerticalNavigationBasicItemComponent, forwardRef(() => FwkVerticalNavigationCollapsableItemComponent), FwkVerticalNavigationDividerItemComponent, FwkVerticalNavigationGroupItemComponent, FwkVerticalNavigationSpacerItemComponent],
})
export class FwkVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any
    {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'fwk-vertical-navigation-item-collapsed': this.isCollapsed,
            'fwk-vertical-navigation-item-expanded' : this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void
    {
        ...
        this._fwkVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._fwkVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._fwkVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._fwkVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _hasActiveChild(item: FwkNavigationItem, currentUrl: string): boolean
    {
     ...
     * @private
     */
    private _isChildrenOf(parent: FwkNavigationItem, item: FwkNavigationItem): boolean
    {
