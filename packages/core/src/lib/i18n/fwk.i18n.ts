...
export const FWK_I18N_DEF = {
  ...
  words: {
    ...
    file_uploader_single_file: 'Permite 1 archivo',
    file_uploader_max_files: 'Límite: {max} archivos',
    file_uploader_no_limit: 'Sin límite de cantidad',
    file_uploader_photos_title: 'Sube fotos',
    file_uploader_files_title: 'Sube archivos',
    file_uploader_array_file_name: 'Archivo {index}',
    file_uploader_current_file: 'Archivo actual',
    file_uploader_saved_file: 'Archivo guardado',
    file_uploader_max_files_reached: 'Máximo de {max} archivos alcanzado.',
    file_uploader_format_not_allowed: 'Formato no permitido: {fileName}',
    file_uploader_size_exceeded: 'El archivo "{fileName}" supera el límite de {maxSizeMB} MB.',
    file_uploader_read_error: 'Error al leer el archivo: {fileName}',
    file_uploader_max_size_label: 'Máx. {maxSizeMB} MB c/u',
    file_uploader_drag_prompt: 'o arrastra aquí',
    file_download_error_message: 'Error al descargar el archivo',
    file_preview_error_message: 'Error al visualizar el archivo',
    file_preview_load_error_message: 'Error al intentar cargar la vista previa.',
    file_download_default_name: 'download',
    file_download_no_content: 'No se encontró contenido para descargar en la respuesta',
    file_download_network_error: 'Error de red al descargar el archivo',
    ...
    boolean_false: 'No',
    boolean_true: 'Sí',
    grid_action_button_edit: 'Editar',
    ...
    // --- Preview de Archivos ---
    preview_uploaded_by: 'Subido por {{username}}',
    preview_loading: 'Cargando vista previa...',
    preview_load_error_title: 'No se pudo cargar el archivo',
    preview_load_error_description: 'El formato no es compatible o el archivo está dañado.',
    preview_size_label: 'Tamaño: {{size}}',
    preview_dimensions_label: 'Dimensiones: {{width}} x {{height}} px',
    preview_download_button: 'Descargar',

    // --- Datepicker ---
    datepicker_invalid_hour: 'La hora es inválida (rango 00:00-23:59)',
    datepicker_invalid_format: 'El formato debe ser {format}',
    datepicker_select_date_title: 'Seleccionar fecha',
    datepicker_invalid_date_message: 'La fecha seleccionada no es válida.',
    datepicker_use_current_datetime: 'Usar fecha y hora actual',
    datepicker_use_current_date: 'Usar fecha actual',
    datepicker_custom_year_label: 'O introduce un año personalizado:',
    datepicker_custom_minute_label: 'O introduce un minuto personalizado:',
    ...
    rating_dialog_title: 'Valorar',
    rating_dialog_message: 'Por favor, califique la calidad de la atención recibida.',
    rating_saved_mock: 'Valoración guardada (sin enviar, URL vacía)',

    // --- HTML Editor ---
    html_editor_insert_menu: 'Insertar',
    html_editor_insert_template_tooltip: 'Insertar Plantilla',
    html_editor_template_menu_item: 'Plantilla',
    html_editor_no_templates: 'No hay plantillas cargadas todavía.',
    html_editor_template_dialog_title: 'Insertar Plantilla',
    html_editor_select_template_label: 'Seleccionar una plantilla para insertar',

    // --- Misceláneos ---
    tags_input_aria_label: 'Ingreso de etiquetas',
    dynamic_url_go_to: 'Ir a {url}',
    dashboard_page_default_title: 'Dashboard',
    dashboard_filter_from: 'Desde',
    dashboard_filter_to: 'Hasta',
    icon_picker_default_label: 'Icono',
    image_no_image: 'Sin imagen',
    image_cropper_select_photo: 'Seleccionar Foto',
    ...
    // --- Auth pages ---
    forgot_password_go_to_login: 'Ir al inicio de sesión ahora',
    auth_security_heading: 'Seguridad',
    auth_account_heading: 'de la Cuenta',
    auth_security_subtitle: 'Mantén tu cuenta segura actualizando tu contraseña periódicamente.',
    auth_invalid_response: 'Respuesta de autenticación inválida.',
    change_password_back_home: 'Inicio',
    sign_out_countdown_one: '# segundo',
    sign_out_countdown_other: '# segundos',

    // --- Servicios ---
    http_operation_failed_no_cause: 'La operación falló pero el servidor no especificó la causa.',
    action_execution_generic_error: 'Se produjo un error al intentar realizar la acción',
    action_no_ws_confirm: 'No se definió un Web Service para esta acción de confirmación',
    form_error_invalid_date: 'Fecha inválida',
    validation_failed_default_message: 'La validación ha fallado.',
    load_data_error_message: 'No se pudieron cargar los registros debido a un problema de conexión o del servidor. Por favor, intente nuevamente más tarde.',
    error_state_offline_title: 'Sin conexión a Internet',
    error_state_offline_subtitle: 'No pudimos conectar con el servidor. Por favor, verifica tu conexión a internet e intenta nuevamente.',
    error_state_server_title: 'Ocurrió un problema al cargar los datos',
    error_state_server_subtitle: 'No se pudo completar la solicitud. Por favor, intenta de nuevo más tarde.',
    error_state_button_back: 'Volver atrás',
    error_state_button_retry: 'Reintentar',
    network_banner_offline: 'Sin conexión a internet. Verifique su red.',
    network_banner_restored: 'Conexión a internet restablecida.',
    dev_tools_sidebar_tooltip: 'Herramientas de Desarrollo',
    dev_tools_back_to_overview: 'Vista General',
    ...
    modal_close_warning_cancel: 'Continuar Editando',
    ...
    confirm_operation_default_message: '¿Está seguro de que desea realizar esta operación?',
    action_error_default_message: 'Error al intentar realizar la acción.',
    action_success_default_message: 'Acción ejecutada con éxito.',
    action_execution_error_message: 'Error al intentar ejecutar la acción.',
    server_error_message: 'Error en el servidor',
    unknown_error_message: 'Ocurrió un error desconocido.',
    data_update_success_message: 'Datos actualizados con éxito.',
    data_update_error_message: 'Error al intentar actualizar los datos.',
    max_selection_items_message: 'Se han seleccionado los primeros 10 elementos (máximo permitido).',
    modal_default_title: 'Aviso',
    modal_got_it_button: 'Entendido',
    ...
    // --- Textos de Plantilla (Ej: Fwk) ---
    our_community: 'nuestra comunidad',
    template_description: 'Fwk ayuda a los desarrolladores a construir paneles organizados y bien codificados, llenos de módulos hermosos y ricos. Únete a nosotros y comienza a construir tu aplicación hoy.',
